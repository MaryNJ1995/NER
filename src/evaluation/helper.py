...
def create_best_result_log(train_logs: dict, valid_logs: dict, test_logs: dict) -> pandas.DataFrame:
    """
    ...
    best_result_log = defaultdict(list)
    train_logs['name'] = 'train'
    valid_logs['name'] = 'valid'
    test_logs['name'] = 'test'

    for dic in (train_logs, valid_logs, test_logs):
        for key, value in dic.items():
            best_result_log[key].append(value)

    return pandas.DataFrame.from_dict(best_result_log)
